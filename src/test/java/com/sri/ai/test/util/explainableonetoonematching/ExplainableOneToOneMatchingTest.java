...
public class ExplainableOneToOneMatchingTest {
	...
	public void test() {
		...
		UnmatchedElementMerger<Integer, Set<String>, String> unmatchedElementMerger = (element, explanations) -> element + " could not be matched: " + join(explanations);
		LeftOverMerger<Set<Integer>, String> leftOverMerger = list -> "Left over: " + join(list);
		...
		actual = match(list1, list2, matcher, unmatchedElementMerger, leftOverMerger, perfectMatch);
