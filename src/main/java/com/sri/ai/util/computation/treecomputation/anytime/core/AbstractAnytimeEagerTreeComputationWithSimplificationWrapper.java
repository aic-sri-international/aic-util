 ...
 */
@Deprecated
public abstract class AbstractAnytimeEagerTreeComputationWithSimplificationWrapper<T> extends AbstractAnytimeEagerTreeComputation<T> {
	 ...
	 * @return
	 */
	abstract protected AbstractAnytimeEagerTreeComputationWithSimplificationWrapper<T> newInstance(NullaryFunction<Approximation<T>> base);
	...
	public AbstractAnytimeEagerTreeComputationWithSimplificationWrapper(AnytimeEagerTreeComputation<T> base) {
...
//		}
	...
	private boolean unsimplifiedCurrentApproximationIsUpdateableByItself() {
		return
				...
				||
				forAll(getSubs(), AbstractAnytimeEagerTreeComputationWithSimplificationWrapper::currentApproximationIsUpdateableByItself);
	}
	...
	private Map<NullaryFunction<Approximation<T>>, AbstractAnytimeEagerTreeComputationWithSimplificationWrapper<T>> fromBaseSubToSub = map();
	
	private AbstractAnytimeEagerTreeComputationWithSimplificationWrapper<T> makeSubForBaseSub(NullaryFunction<Approximation<T>> baseSub) {
	...
	@Override
	public ArrayList<? extends AbstractAnytimeEagerTreeComputationWithSimplificationWrapper<T>> getSubs() {
		return (ArrayList<? extends AbstractAnytimeEagerTreeComputationWithSimplificationWrapper<T>>) super.getSubs();
	}
